...
const falloutConfig: GlossaryConfig = {
	type: 'fallout',
	title: 'База текстов Fallout | RuESO',
	description: 'Полная база текстов всех игр серии Fallout: от Fallout 1 до Fallout 76.',
	...
	gameCheckboxes: [
		{ id: 'Fallout 1', name: 'Fallout (1997)', icon: '/img/icons/fallout1.png', disabled: true },
		{ id: 'Fallout 2', name: 'Fallout 2 (1998)', icon: '/img/icons/fallout2.png', disabled: true },
		{ id: 'Tactics', name: 'Fallout Tactics (2001)', icon: '/img/icons/fallout-tactics.png', disabled: true },
		// { id: 'Brotherhood of Steel', name: 'Fallout: Brotherhood of Steel (2004)', icon: '/img/icons/fallout-bos.png', disabled: true },
		{ id: 'Fallout 3', name: 'Fallout 3 (2008)', icon: '/img/icons/fallout3.png' },
		{ id: 'New Vegas', name: 'Fallout: New Vegas (2010)', icon: '/img/icons/falloutnv.png' },
