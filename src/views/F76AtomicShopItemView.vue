					...
					<div class="modal-content">
						...
						<div class="modal-body" style="padding:30px 30px 20px;">
							...
							<div class="alert alert-info" role="alert">
								<strong>Внимание!</strong> На сайте возможны неточности. Тщательно проверяйте все названия во время оформления заказа. Если вы обнаружили ошибку, сообщите об этом в <a href="https://discord.com/users/304996291765600258" target="_blank">Discord</a> (terab1t).
							</div>
						</div>
					</div>
				</div>
